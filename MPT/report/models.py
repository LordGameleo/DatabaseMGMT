...
class Shift(models.Model):
    ...
    shift_end_flag = models.IntegerField(default = 0) #if it is 0 then shift hasn't been ended
...
class Slot(models.Model):
    ...
    def total_time(self):
        ...
        if self.time_slot_start.hour >= 23 and self.time_slot_stop.hour < 23:
            t_stop = datetime.timedelta(days = 1, hours = self.time_slot_stop.hour, minutes = self.time_slot_stop.minute)
